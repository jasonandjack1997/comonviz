 ...
 * @author seanf
 */
public class CopyOfProtegeInputEventHandler extends PBasicInputEventHandler {
	...
	public CopyOfProtegeInputEventHandler(ProtegeGraphModel graphModel, AbstractGraph graph) {
