...
public class ComonVizArcLabel extends PNode implements GraphNode {
	...
	private GraphArc graphArc;



	public ComonVizArcLabel(GraphArc graphArc, String text,  Object type, Object userObject, Icon icon) {
		super();
		...
		this.style = new DefaultArcLabelStyle();
		this.selected = false;
...
//			textNode.setBounds(getX() + PADDING_X + iconWidth + ICON_GAP, getY() + PADDING_Y, textNode.getWidth(), textNode.getHeight());
	...
	public int compareTo(Object o) {
		if (o instanceof ComonVizArcLabel) {
			ComonVizArcLabel node = (ComonVizArcLabel) o;
...
//		setBounds(middlePoint.getX() - w/2.0 , middlePoint.getY() - h/2.0, w, h);
	...
	class GraphTextNode extends PText {
		...
		@Override
		public Font getFont() {
			Font font = style.getFont(ComonVizArcLabel.this);
			if (font == null) {
				font = DEFAULT_FONT;
			}
			return font;
		...
		public Paint getTextPaint() {
			Paint paint = style.getTextPaint(ComonVizArcLabel.this);
			if (paint == null) {
				paint = Color.black;
			}
			return paint;
