...
public class ComonVizGraphArc extends PPath implements GraphArc {
	...
	public ComonVizGraphArc(Object userObject, GraphNode src, GraphNode dest) {
		this(userObject, src, dest, UNKNOWN_TYPE);
	}
	
	public ComonVizGraphArc(Object userObject, GraphNode src, GraphNode dest, Object type) {
		this(userObject, src, dest, null, type);
	}
	
	public ComonVizGraphArc(Object userObject, GraphNode src, GraphNode dest, Icon icon, Object type) {
		super();
