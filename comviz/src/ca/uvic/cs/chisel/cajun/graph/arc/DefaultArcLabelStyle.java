...
import unused.ComonVizArcLabel;
...
/**
 * Provides the default styles for {@link ComonVizArcLabel}s. Supports different styles based on
 ...
 * @since  08-Nov-07
 */
public class DefaultArcLabelStyle implements GraphNodeStyle {
	...
	public DefaultArcLabelStyle() {
		...
		this.bgPaint2 = new GradientPaint(0, 0, Color.blue, 0, 20, defaultNodeColor, true);
