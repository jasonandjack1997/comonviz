 ...
 * @since  30-Oct-07
 */
public class ComonVizGraphNode extends PNode implements GraphNode {
	...
	public ComonVizGraphNode(Object userObject) {
		this(userObject, String.valueOf(userObject));
	}

	public ComonVizGraphNode(Object userObject, String text) {
		this(userObject, text, null);
	}

	public ComonVizGraphNode(Object userObject, String text, Icon icon) {
		this(userObject, text, icon, null);
	}

	public ComonVizGraphNode(Object userObject, String text, Icon icon, Object type) {
		super();
	...
	public int compareTo(Object o) {
		if (o instanceof ComonVizGraphNode) {
			ComonVizGraphNode node = (ComonVizGraphNode) o;
	...
	class GraphTextNode extends PText {
		...
		@Override
		public Font getFont() {
			Font font = style.getFont(ComonVizGraphNode.this);
			if (font == null) {
				font = DEFAULT_FONT;
			}
			return font;
		...
		public Paint getTextPaint() {
			Paint paint = style.getTextPaint(ComonVizGraphNode.this);
			if (paint == null) {
				paint = Color.black;
			}
			return paint;
